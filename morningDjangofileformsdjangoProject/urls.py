"""
URL configuration for morningDjangofileformsdjangoProject project.
...
urlpatterns = [
    ...
    path('add-product/', user_views.add_products, name='add-products'),
    path('product/', user_views.products, name='all-products'),
